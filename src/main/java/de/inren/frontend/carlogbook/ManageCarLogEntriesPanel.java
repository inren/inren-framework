 ...
 * 
 */
public class ManageCarLogEntriesPanel extends ManagePanel implements IAdminPanel {
    ...
    public ManageCarLogEntriesPanel(String id, IWorktopManageDelegate<CarLogEntry> delegate) {
        super(id);
    ...
    protected final Component getTable(final String id) {
        AjaxFallbackDefaultDataTableBuilder<CarLogEntry> builder = new AjaxFallbackDefaultDataTableBuilder<CarLogEntry>(ManageCarLogEntriesPanel.this);

        Component table = builder.addDataProvider(new RepositoryDataProvider<CarLogEntry>(logBookRepository))
                .add(new AbstractColumn<CarLogEntry, String>(new StringResourceModel("actions.label", ManageCarLogEntriesPanel.this, null)) {
                    @Override
                ...
                }).addPropertyColumn("id", true).addPropertyColumn("carId", true).addPropertyColumn("totalKm", true).addPropertyColumn("fuel", true)
    ...
    protected Component getActionPanel(String id) {
        ...
        ButtonGroup bg = new ButtonGroup(id) {
            ...
            protected List<AbstractLink> newButtons(String buttonMarkupId) {
                List<AbstractLink> res = new ArrayList<AbstractLink>();
                StringResourceModel srm = new StringResourceModel("actions.create.carlogentry", ManageCarLogEntriesPanel.this, null);

...
public abstract class AActionB4Link extends AActionLink {
    ...
    public AActionB4Link(boolean ajax, GlyphIconType iconType) {
        this(ajax, iconType, null);
    }

    public AActionB4Link(boolean ajax, GlyphIconType iconType, StringResourceModel message) {
        super("item", message);
        this.ajax = ajax;
        this.iconType = iconType;
    }

    public AActionB4Link(boolean ajax, GlyphIconType iconType, StringResourceModel message, StringResourceModel label) {
